...
# FastAPI Authentication & Authorization (Day18)

## Overview
FastAPI + SQLAlchemy を用いた JWT 認証・権限制御の実装例。
pytest による E2E テストまで含め、実務想定で構築。
...
## Key Design Points
- 認証と権限制御を dependencies に分離
- テスト用 DB と本番 DB を dependency override で切替
- 「401」と「403」を仕様通りに分離
